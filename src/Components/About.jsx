...
function AboutMe() {
  ...
  const overviewIcon =
    "https://cdn-icons-png.flaticon.com/512/7756/7756168.png";
  const developerIcon =
    "https://cdn-icons-png.flaticon.com/512/3242/3242313.png";
  const softwareIcon =
    "https://cdn-icons-png.flaticon.com/512/9307/9307617.png";
      ...
      <main className="about-container main">
        <section className="header">
          ...
          <div className="good-day primary p-1 px-sm-5" data-aos="fade-up">
            <h2>
              Hey there!
              <img loading="lazy" src={waveIcon} alt="Code" className="icons" />
            </h2>
            <h2>
              I'm Jose Gabriel F. Fabileña.{" "}
              <img
                loading="lazy"
                src={personIcon}
                alt="Code"
        ...
        <section className="about-container">
          <article className="about-text-container">
            <h1 className="mb-5 primary" data-aos="fade-right">
              Overview{" "}
              <img
                loading="lazy"
                src={overviewIcon}
            ...
            <p className="about-text secondary" data-aos="fade-right">
              ...
              my next goal is{" "}
              <em>
                to obtain a Junior Web Developer{" "}
                <img
                  loading="lazy"
                  src={developerIcon}
                  alt="Code"
              ...
              that assists in building websites, apps or softwares.{" "}
              <img
                loading="lazy"
                src={softwareIcon}
                alt="Code"
              ...
              <br />
              <br />
              My daily target to develop my skills and discover my potential
              while working with a team of experts and professionals{" "}
              <img loading="lazy" src={teamIcon} alt="Code" className="icons" />
              .
            </p>
          </article>

          <article className="about-text-container">
            <h1 className="mt-5 mb-5 primary" data-aos="fade-right">
            ...
            <p className="about-text secondary" data-aos="fade-right">
              ...
              practiced at FreeCodeCamp.org where I started learning how to code
              using HTML{" "}
              <img loading="lazy" src={html} alt="Code" className="icons" /> and
              CSS <img loading="lazy" src={css} alt="Code" className="icons" />.
              <br />
              <br />
              My interests in Cryptocurrencies, NFTs, Trading and Financial
              Technology led me to start learning how to code. As I was
              practicing coding everyday, I decided to pursue a career in coding{" "}
              <img
                loading="lazy"
                src={codingIcon}
                alt="Code"
              ...
              <br />
              <br />
              After two weeks of self-studying and researching, I enrolled in
              KodeGo's Full-Stack Web Development course and joined my first
              online coding class last September 30, 2022.
            </p>
          </article>
        </section>
      </main>
      ...
      <main ref={details} className="main">
        ...
        <article className="certificates">
          ...
          <div className="summary">
            <Certificate image={FullStack} />

            <Certificate image={RedHatLinux} />

            <Certificate image={GoogleUX} />

            <Certificate image={GooglePM} />

            <Certificate image={Scrum} />

            <Certificate image={Duda} />

            <Certificate image={ResponsiveWebDesign} />
          </div>
        </article>
        ...
        <article className="tech-skills">
          ...
          <div className="summary">
            <div className="skill">
              <Skill image={html} tech_stack="HTML" />

              <Skill image={css} tech_stack="CSS" />

              <Skill image={bootstrap} tech_stack="Bootstrap" />

              <Skill image={javascript} tech_stack="JavaScript" />

              <Skill image={reactjs} tech_stack="React JS" />

              <Skill image={php} tech_stack="PHP" />

              <Skill image={DudaIcon} tech_stack="Duda" />

              <Skill image={Chime} tech_stack="Chime IDX" />
            </div>
          </div>
        </article>
        ...
        <article className="soft-skills">
          ...
          <div className="summary">
            <div className="skill">
              <Soft soft_skills="Communication" />

              <Soft soft_skills="Problem Solving" />

              <Soft soft_skills="Flexibility" />

              <Soft soft_skills="Attention-To-Detail" />

              <Soft soft_skills="Collaboration" />
            </div>
          </div>
        </article>
      </main>
